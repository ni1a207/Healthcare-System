...
| Метод и полный путь (через Gateway)                    | Описание |
|:-------------------------------------------------------|:-|
| [POST /auth/login ](..%2FAPI%2FPOST.api.auth.login.md) | Аутентификация пользователя. Генерация JWT. |
| [GET /auth/validate](..%2FAPI%2FGET.validate.md)       | Валидация JWT при внешних запросах к системе. |
