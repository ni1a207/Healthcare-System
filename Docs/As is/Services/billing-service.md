...
## База данных
В текущей версии кода (`BillingGrpcService.java`) персистентный слой не реализован. Бизнес-логика по сохранению данных в БД имитируется: сервис возвращает статические значения `accountId: "12345"` и `status: "ACTIVE"`.
