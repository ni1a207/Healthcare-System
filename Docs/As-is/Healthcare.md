...
4.  `auth-service-db` в таблице `users` находит запись и возвращает данные.
...
9. `frontend` получает ответ, перенаправляет на главную страницу системы.
...
1. Пользователь делает запрос к системе. `frontend` отправляет все запросы к системе через `api-gateway` с заголовком `Authorization: Bearer <token>`.
...
1. Пользователь нажимает кнопку "Пациенты". `frontend` отправляет HTTP-запрос [GET api/patients](API%2FGET.patients.md) с заголовком `Authorization: Bearer <token>`.
2. Запрос поступает в `api-gateway`, который инициирует валидацию `JWT`, отправляет HTTP-запрос [GET /validate](API%2FGET.validate.md) в `auth-service`.
3. `api-gateway` проксирует запрос в `patient-service`.
...
3. `api-gateway` проксирует запрос в `patient-service`.
4. `patient-service` находит запись пациента в `patient-service-db` по `id`, проверяет уникальность `email`, обновляет поля и сохраняет изменения.
...
| [auth-service](Services%2Fauth-service.md)           | PostgreSQL<br/> [auth-service-db](DB%2Fauth-service-db.md)      | REST                           | Управление пользователями и сессиями |
| [patient-service](Services%2Fpatient-service.md)     | PostgreSQL <br/> [patient-service-db.md](DB%2Fpatient-service-db.md)    | REST, gRPC, Kafka producer     | Мастер-система для данных пациентов  |
...
|:-----------|:--------------------------------------|:--------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **FR-001** | Аутентификация                        | **MVP** | [api-gateway](Services%2Fapi-gateway.md)<br/>[auth-service](Services%2Fauth-service.md)                                                                                                                  | [auth-service-db](DB%2Fauth-service-db.md)       | [Алгоритмы API Gateway](API%2FAPIGateway.md) <br/>[POST /login](API%2FPOST.login.md)                                                                                                                                         |
| **FR-002** | Авторизация и маршрутизация           | **MVP** | [api-gateway](Services%2Fapi-gateway.md)<br/>[auth-service](Services%2Fauth-service.md)                                                                                                                  | -                                                | [Алгоритмы API Gateway](API%2FAPIGateway.md)   <br/>[GET /validate](API%2FGET.validate.md)                                                                                                                                                                                       |
| **FR-003** | Регистрация пациента и создание счета | **MVP** |  [api-gateway](Services%2Fapi-gateway.md)<br/>[patient-service](Services%2Fpatient-service.md)  <br/> [billing-service](Services%2Fbilling-service.md)  <br/> [analytics-service (async consumer)](Services%2Fanalytics-service.md) <br/> [kafka](Services%2Fkafka.md) | [patient-service-db](DB%2Fpatient-service-db.md) | [POST /patients](API%2FPOST.patients.md) <br/> [CreateBillingAccount](API%2FCreateBillingAccount.md) <br/> [PatientEventProducer](API%2FPatientEventProducer.md) <br/> [PatientEventConsumer](API%2FPatientEventConsumer.md) |
| **FR-004** | Просмотр зарегистрированных пациентов | **MVP** |  [api-gateway](Services%2Fapi-gateway.md)<br/>[patient-service](Services%2Fpatient-service.md)                                                                                                                                                         | [patient-service-db](DB%2Fpatient-service-db.md) | [GET /patients](API%2FGET.patients.md)                                                                                                                                                                                       |
| **FR-005** | Изменение личных данных пациента      | **MVP** | [api-gateway](Services%2Fapi-gateway.md)<br/> [patient-service](Services%2Fpatient-service.md)                                                                                                                                                         | [patient-service-db](DB%2Fpatient-service-db.md) | [PUT /patients/{id}](API%2FPUT.patients.id.md)                                                                                                                                                                               |
| **FR-006** | Удаление пациента                     | **MVP** | [api-gateway](Services%2Fapi-gateway.md)<br/> [patient-service](Services%2Fpatient-service.md)                                                                                                                                                         | [patient-db](DB%2Fpatient-service-db.md)         | [DELETE /patients/{id}](API%2FDELETE.patients.id.md)                                                                                                                                                                         |
