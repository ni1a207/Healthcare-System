...
**Контроль доступа**: Сервис настроен на permitAll(). Ограничение доступа к эндпоинтам авторизации не требуется, так как проверка прав и валидация токена реализованы внутри бизнес-логики.
...
## База данных: [auth-service-db](..%2FDB%2Fauth-service-db.md)
